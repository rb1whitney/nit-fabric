...
2.  **Is it UI/Interaction heavy?**
    *   *Yes* -> Use `appEvalTest` (`AppRig`). See **[{{SKILL_DIR}}/references/creating.md]({{SKILL_DIR}}/references/creating.md)**.
    *   *No* -> Use `evalTest` (`TestRig`). See **[{{SKILL_DIR}}/references/creating.md]({{SKILL_DIR}}/references/creating.md)**.
3.  **Is it a new test?**
    *   *Yes* -> Set policy to `USUALLY_PASSES`.
    *   *No* -> `ALWAYS_PASSES` (locks in regression).
4.  **Are you fixing a failure or promoting a test?**
    *   *Fixing* -> See **[{{SKILL_DIR}}/references/fixing.md]({{SKILL_DIR}}/references/fixing.md)**.
    *   *Promoting* -> See **[{{SKILL_DIR}}/references/promoting.md]({{SKILL_DIR}}/references/promoting.md)**.
...
*   *Details in **[{{SKILL_DIR}}/references/creating.md]({{SKILL_DIR}}/references/creating.md)***
...
| :--- | :--- | :--- |
| **Creating** | [creating.md]({{SKILL_DIR}}/references/creating.md) | Creating new behavioral tests. |
| **Fixing** | [fixing.md]({{SKILL_DIR}}/references/fixing.md) | Fixing failing tests. |
| **Promoting** | [promoting.md]({{SKILL_DIR}}/references/promoting.md) | Promoting tests to ALWAYS_PASSES. |
| **Running** | [running.md]({{SKILL_DIR}}/references/running.md) | Running the test suite. |